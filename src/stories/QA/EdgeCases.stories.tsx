    ...
    events: [
      {
        ...
        endDate: today.hour(12).minute(0).format("YYYY-MM-DDTHH:mm:00"),
        title: "2-Hour Outer",
...
export const LayoutOverlapOffset: Story = {
  args: {
    ...
    events: [
      ...
      {
        id: "o2",
        startDate: today.hour(13).minute(30).format("YYYY-MM-DDTHH:mm:00"),
        endDate: today.hour(15).minute(30).format("YYYY-MM-DDTHH:mm:00"),
        title: "Offset Layer 2",
        style: { backgroundColor: "#f87171" },
      },
      {
        id: "o3",
        startDate: today.hour(14).minute(0).format("YYYY-MM-DDTHH:mm:00"),
        endDate: today.hour(16).minute(0).format("YYYY-MM-DDTHH:mm:00"),
  ...
  args: {
    ...
    events: [
      ...
      },
      {
        ...
        startDate: today.hour(14).minute(0).format("YYYY-MM-DDTHH:mm:00"),
        endDate: today.hour(12).minute(0).format("YYYY-MM-DDTHH:mm:00"), // Reverses time!
        title: "Negative Duration (Should ignore/fail safe)",
        style: { backgroundColor: "#8b5cf6" },
      },
      {
        id: "missing-end",
        startDate: today.hour(16).minute(0).format("YYYY-MM-DDTHH:mm:00"),
  ...
  args: {
    ...
    events: [
      ...
      },
      {
        // Overnight Datetime
        id: "on",
        startDate: today.hour(22).minute(0).format("YYYY-MM-DDTHH:mm:00"),
        endDate: today
          .add(1, "day")
          .hour(2)
          .minute(0)
