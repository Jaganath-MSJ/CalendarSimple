...
export const DAY_LIST = {
  ...
  MONDAY: { FULL: "Monday", HALF: "Mon" },
  TUESDAY: { FULL: "Tuesday", HALF: "Tue" },
  WEDNESDAY: { FULL: "Wednesday", HALF: "Wed" },
  THURSDAY: { FULL: "Thursday", HALF: "Thu" },
  FRIDAY: { FULL: "Friday", HALF: "Fri" },
  SATURDAY: { FULL: "Saturday", HALF: "Sat" },
};
